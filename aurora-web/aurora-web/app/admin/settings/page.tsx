...
export default function AdminSettings() {
  ...
  const resetJoinSection = () => {
    ...
    setSupportServerUrl("https://discord.gg/zTTMRnU9G");
    ...
    const initPage = async () => {
      try {
        ...
        if (settingsRes.ok) {
          ...
          setSupportServerUrl(settings.supportServerUrl || "https://discord.gg/zTTMRnU9G");
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="flex bg-black/45 p-1 rounded-2xl border border-white/10 mb-6 overflow-x-auto max-w-full gap-1">
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all whitespace-nowrap ${activeMainTab === 'general'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all whitespace-nowrap ${activeMainTab === 'landing'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-semibold transition-all whitespace-nowrap ${activeMainTab === 'legal'
                    ...
                    <div className="flex bg-black/40 p-1 rounded-xl border border-white/5 overflow-x-auto max-w-full">
                      {(['hero', 'about', 'features', 'join', 'team'] as const).map((tab) => (
                        <button
                          ...
                          className={`px-3 py-1.5 rounded-lg text-xs font-semibold uppercase tracking-wider transition-all whitespace-nowrap ${activeLandingTab === tab
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                      ...
                      <div className="flex bg-black/40 p-1 rounded-xl border border-white/5 self-start">
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activePrivacyTab === 'edit'
                        ...
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activePrivacyTab === 'preview'
                              ? 'bg-purple-500 text-white'
                              : 'text-gray-400 hover:text-white'
                            }`}
                        >
                    ...
                    <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                      ...
                      <div className="flex bg-black/40 p-1 rounded-xl border border-white/5 self-start">
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activeTermsTab === 'edit'
                              ? 'bg-purple-500 text-white'
                              : 'text-gray-400 hover:text-white'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${activeTermsTab === 'preview'
                              ? 'bg-purple-500 text-white'
                              : 'text-gray-400 hover:text-white'
                            }`}
                        >
