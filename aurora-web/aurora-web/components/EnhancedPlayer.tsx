...
import { 
  ...
  Shuffle, Volume2, List, X, ExternalLink, Music2
} from 'lucide-react';
...
export default function EnhancedPlayer({ guildId, userId }: { guildId: string; userId: string }) {
  const {
    currentTrack,
    queue,
    isPlaying,
  ...
  // Listen for toast events from the hook
  useEffect(() => {
